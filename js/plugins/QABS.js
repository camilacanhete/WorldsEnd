...
(function() {
  ...
  Game_Action.prototype.absApply = function(target) {
    ...
    result.missed = $gamePlayer.isRolling(); //csantos: added missed statement
    if(!result.missed) { //csantos: only enters here if result is not missed
